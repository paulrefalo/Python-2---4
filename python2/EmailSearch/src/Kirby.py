...
def msg_by_message_id(message_id, conn, curs):
    """
...
def msgs(conn, curs, mindate=None, maxdate=None, namesearch=None, addsearch=None,): # <---- CHANGED
    """
