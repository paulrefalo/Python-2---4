...
def string_to_date(date):
    ...
    """
    try:
        # create a datetime obj from the date value
...
def birthday_counter(birthday):
    ...
    #construct the upcoming birthday from this year, your b-month, and b-day
    ...
    #create a timedelta (duration) between thenow and your birthday
