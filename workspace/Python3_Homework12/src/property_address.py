...
class Address:
    ...
    def __init__(self, name, street_address, city, state, zip_code):
        ...
        self._state_pattern = config.get('validators', 'state')
        self._zip_pattern = config.get('validators', 'zip_code')
    ...
    def state(self, stateValue):
        ...
        m = re.match( self._state_pattern, stateValue)
        if m:
            self._state = m.group()
        else:
    ...
    def zip_code(self, zipValue):
        ...
        matchObj = re.search( self._zip_pattern, zipValue)
        if matchObj:
...
if __name__ == '__main__':
    ...
    try:
        dataTest = Address( name=options.name, street_address=options.street_address, 
                            city=options.city, 
                            state_pattern = config.get('validators', 'state'),
                            zip_pattern = config.get('validators', 'zip_code'),
